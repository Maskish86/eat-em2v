...
from external.EAT.utils.data_utils import compute_block_mask_1d, get_buckets, get_bucketed_sizes
    ...
    def __getitem__(self, index):
        ...
        if self.wav2fbank:
            ...
            if diff > 0:
                ...
                feats = feats[:, start : start + self.target_length, :]
